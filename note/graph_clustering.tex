...
&\textit{s.t.}                                                                       \nonumber \\
&\sum_{c=1}^k x_{ic} = 1                                                            \quad \forall i \in \{1, \ldots, |V|\} \\
& y_{ijc} \geq x_{ic} + x_{jc} -1                                                    \quad \forall c \in \{1, \ldots, k\}, \forall (i,j) \in E_o \\
& s \leq \sum_{i=1}^{|V|} x_{ic}                                                   \quad \forall c \in \{1, \ldots, k\} \\
& \mathsf{connected}(x_{1c}, \ldots, x_{|V|c})                                       \quad \forall c \in \{1, \ldots, k\} \\
& x_{ic} \in \{0, 1\}                                                                 \forall c \in \{1, \ldots, k\}, \forall i \in \{1, \ldots, |V|\} \\
& y_{ijc} \in \{0, 1\}                                                               \forall c \in \{1, \ldots, k\}, \forall (i, j) \in E_o \\
