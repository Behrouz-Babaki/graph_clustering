...
\centering
\captionsetup{font=small}
\captionof{table}{Average runtimes of overlapping and non-overlapping clustering by enumerating all simple paths (ENUM) and branch and cut (BnC). Experiments were terminated after 1800 seconds (--).}
\label{table:runtime}
